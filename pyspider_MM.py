...
class Handler(BaseHandler):
    ...
    @every(minutes=24 * 60)
    def on_start(self):
        self.crawl('http://csgh.maoming.gov.cn/active/show.ashx?action=certList&pwd=&chk=1&key=&no=&sid=1&page=1', callback=self.index_page)
        self.crawl('http://csgh.maoming.gov.cn/active/show.ashx?action=certList&pwd=&chk=1&key=&no=&sid=2&page=1', callback=self.index_page)
        self.crawl('http://csgh.maoming.gov.cn/active/show.ashx?action=certList&pwd=&chk=1&key=&no=&sid=3&page=1', callback=self.index_page)
        self.crawl('http://csgh.maoming.gov.cn/active/show.ashx?action=certList&pwd=&chk=1&key=&no=&sid=4&page=1', callback=self.index_page)
    ...
    def content_page(self, response):
        ...
        # path = 'D:/web/' + web_name + '/'
        path = '/home/teer/web/MM/' + web_name + '/'
